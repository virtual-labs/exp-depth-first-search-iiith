...
DFS.prototype.setup = function() 
{
	...
	for (var i = 0; i < this.size; i++)
	{
		...
		this.cmd("SetBackgroundColor", this.circleID[i], "#FFFFFF");
...
DFS.prototype.dfsVisit = function(startVertex, messageX)
{
	...
	this.cmd("SetBackgroundColor", this.circleID[startVertex], "#ADD8E6");
	if (!this.visited[startVertex])
	{
		this.visited[startVertex] = true;
		this.cmd("SetBackgroundColor", this.circleID[startVertex], "#ADD8E6");
		// this.cmd("SetBackgroundColor", this.adj_matrix[startVertex], "#ADD8E6");
		...
		for (var neighbor = 0; neighbor < this.size; neighbor++) {
			...
			if (this.adj_matrix[startVertex][neighbor] > 0) {
				if (!this.visited[neighbor]) {
					this.cmd("SetBackgroundColor", this.circleID[neighbor], "#FFA500");
					// console.log("Hello\n");
				}
			}
		}
		for (var neighbor = 0; neighbor < this.size; neighbor++)
		{
			if (this.adj_matrix[startVertex][neighbor] > 0)
			{
				...
				// this.cmd("SetBackgroundColor", this.visitedID[neighbor], "#123456");
				if (this.visited[neighbor])
				{
					nextMessage = this.nextIndex;
					// this.cmd("SetBackgroundColor", this.circleID[neighbor], "#123456");
